...
object SoundsRepository {
    ...
    // NOTA: URLs acima são de exemplo. Substitua por seus próprios áudios de meditação.
    // Fontes de áudios gratuitos: Freesound.org, Pixabay Music, YouTube Audio Library
}
